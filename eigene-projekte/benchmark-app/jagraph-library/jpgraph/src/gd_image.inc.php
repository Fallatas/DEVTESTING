    ...
    function SetImgFormat($aFormat,$aQuality=75) {
        ...
        if( $aFormat=="auto" ) {
            ...
            elseif( $supported & IMG_XPM )  $this->img_format="xpm";
                ...
                JpGraphError::RaiseL(25109);//("Your PHP (and GD-lib) installation does not appear to support any known graphic formats. You need to first make sure GD is compiled as a module to PHP. If you also want to use JPEG img you must get the JPEG library. Please see the PHP docs for details.");
            }
            return true;
        }
        else {
